...
- Four slots, and the difference matters: ACTIVE scores; BENCH doesn't; IR frees a roster spot but STILL counts against the cap; REDSHIRT frees the spot AND the cap room. Redshirt is only for a rookie who has never played, costs a league fee to place and another to activate, and once activated she can never be redshirted again — always say the fee and the one-way nature before doing it, and only on a clear yes.
